  ...
  Widget build(BuildContext context) {
    ...
    final firstChildWidget = _children.isEmpty
        ...
        : ListTile(
            ...
            subtitle: Text(
              '${(_children.first.checkedIn ?? false) ? translate('profile.active') : translate('profile.inactive')}${_children.first.document != null && _children.first.document!.isNotEmpty ? ' · ${_children.first.document}' : ''}',
            ),
            onTap: () {
              Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                  builder: (_) => ProfileScreen(selectedChild: _children.first),
                ),
              );
            },
          );
              ...
              return Column(
                children: [
                  ListTile(
                    ...
                    title: Text(c.name ?? ''),
                    subtitle: Text(
                      '${(c.checkedIn ?? false) ? translate('profile.active') : translate('profile.inactive')}${c.document != null && c.document!.isNotEmpty ? ' · ${c.document}' : ''}',
                    ),
                    onTap: () {
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
